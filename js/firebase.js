...
async function loadQuestionProgress(studentId,questionId){const ref=collection(db,...ASSESSMENT_PATH,studentId,'preguntas');const snap=await getDocs(query(ref,where('__name__','==',questionId)));return snap.empty?null:snap.docs[0].data()}
